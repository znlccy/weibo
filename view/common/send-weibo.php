...
<script>
    $(function () {
        $('.emotion').qqFace({
            ...
            path: 'public/images/face/'     //表情存放位置
        });
    });
</script>
...
<div class="send-weibo">
    ...
    <div class="send-action">
        ...
        <span>
            <a class="at-friend" style="font-size: 14px">
                <i class="at large icon"></i>一下
            </a>
        </span>
        <span>
            <a id="btn" href="javascript:;" style="font-size: 14px">
                <i class="file image outline large icon"></i>图片
            </a>
        </span>
        <div class="release" style="font-size: 14px">
            <span class="countTxt">
                还可输入<em id="sayword_0" class="count">140</em>字
            </span>
            <button class="ui teal button" onclick="saysub(0)" style="font-size: 15px">发布</button>
        </div>
    </div>
    ...
    <div class="interest-link" style="display: none">
        ...
        <div class="interest-scroll">
            <div id="friends" class="interest-scroll-content">
                <?php
                    $user_lists = $db->query('select username from zc_user');
...
<div class="photo_upload_box_outside" id="photo_upload_box_outside" tabindex="2000">
    <div class="photo_upload_box">
        ...
        <h1>本地上传</h1>
        <p class="upload_num">共<span id="upload_length">0</span>张，还能上传<span id="upload_other">9</span>张</p>
        <ul id="ul_pics" class="ul_pics clearfix">
            <li id="local_upload">
                <img src="public/images/local_upload.png" id="btn2">
            </li>
        </ul>
...
<script type="text/javascript">
    ...
    var uploader = new plupload.Uploader({                      //创建实例的构造方法
        runtime: 'gears,html5,html4,silverlight,flash'          //上传插件初始化选用那种方式的优先级顺序
        ...
        filter: {
            ...
            mime_types: [{
                title: "files",
                extensions: "jpg,png,gif,jpeg",                 //允许上传类型
            }],
        },
        multi_selection: true,                                  //true:ctrl多文件上传
        init: {
            ...
            FileUploaded: function(up, file, info) {           //文件上传成功之后出发
            ...
            Error: function (up, err) {                         //上传出错的时候出发
                alert(err.message);
            }
        },
    });
