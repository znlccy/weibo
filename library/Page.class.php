...
class Page {
    ...
    private $show_pages;        //显示页数

    /**
     * 默认构造函数
     * Page constructor.
     * @param int $myde_total
     * @param int $myde_size
     * @param int $myde_page
     * @param unknown $myde_url
     * @param int $show_page
     */
    public function __construct($myde_total = 1, $myde_size = 1, $myde_page = 1, $myde_url, $show_pages = 2) {
        $this->myde_total = $this->numberic($myde_total);
        $this->myde_size = $this->numberic($myde_size);
        $this->myde_page = $this->numberic($this->myde_page);
